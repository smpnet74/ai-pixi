...
echo -e "  ${BOLD}3.${RESET} ${BLUE}pixi run install-starship${RESET}      ${DIM}# (optional) Install starship prompt — skips if already configured${RESET}"
echo -e "  ${BOLD}4.${RESET} ${BLUE}source ~/.zshrc${RESET}                ${DIM}# Activate (or restart your shell)${RESET}"
echo ""
...
echo -e "  ${BLUE}pixi run install-starship${RESET}     ${DIM}# Install starship prompt + config (skips if already installed/configured)${RESET}"
